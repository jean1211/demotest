...
router.get("/query", function(req, res, next) {
    head(res);
    db.query(userSql.query, [req.query.account], function(err, result) {
...
router.post('/add', (req, res, next) => {
    head(res);
    let params = req.body;
    db.query(userSql.insert, [params.account,params.date, params.time, params.address, params.name, params.phone, params.type, params.size, params.number], function(err, result) {
        res.json(result)
    })
